...
{
double res, r1, r2, ry, cost, h0, nv, iv;
double *J;
int ev,ii, i, q;
	res=0;
...
double compute_loss_jac_diff(int8_t *rs, int count, int *indir, long offset,double *JJ, double *ival, double *nval, int par, int pcount)
{
double res, r1, r2, ry, cost, h0, nv, iv;
double *J;
int ev,ii, i, q;
